...
| POST | `/clientzone/lead/account/transactions` | Bearer client (withdraw create) |
| PATCH | `/clientzone/lead/account/transactions/:id` | Bearer client (withdraw cancel) |
| GET | `/clientzone/transaction-source/get` | Bearer client |
